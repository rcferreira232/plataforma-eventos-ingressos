  ...
  const handleCopyShareLink = async (ticket: Ticket) => {
    ...
    try {
      ...
      toast.success("Link do ingresso copiado!", {
        description:
          "O link assinado foi copiado para a área de transferência.",
      });
    } catch {
        ...
        <Card className='p-12 text-center space-y-4'>
          ...
          <div className='pt-2'>
            <Link href='/client/events'>
              <Button className='gap-2'>Explorar Catálogo de Eventos</Button>
            </Link>
          </div>
        </Card>
      ) : (
              ...
              >
                ...
                <CardContent className='flex-1 space-y-6 pt-6 flex flex-col items-center justify-center text-center'>
                  ...
                  <p className='text-xs text-muted-foreground max-w-xs'>
                    Apresente este QR Code na portaria do evento para liberação
                    de acesso.
                  </p>
                </CardContent>
