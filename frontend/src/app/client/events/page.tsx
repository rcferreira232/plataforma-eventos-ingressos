...
import { Calendar, MapPin, Ticket as TicketIcon, Search, Sparkles, ArrowRight } from "lucide-react";
    ...
    <Container size="xl" className="py-8 space-y-8">
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center min-h-[40vh] gap-3">
          ...
          <p className="text-sm text-muted-foreground">Buscando eventos disponíveis...</p>
        </div>
      ) : isError ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredEvents.map((event) => (
            <Card key={event.id} className="flex flex-col justify-between hover:border-primary/50 transition-all">
              <CardHeader>
